...
class RandomGen:
    ...
    def random_number(self, min=0, max=100) -> int:
        """Generates random positive integer in the range specified. If no limits are set defaults to from 0 to 99
        ...
        Args:
            ...
            max (int, optional): upper bound, exclusive. Defaults to 100.
